...
#[Inicio do Programa]
    ...
    echo "(01/15)Alterando o mirror do Ubuntu";
    sudo mv /etc/apt/sources.list /etc/apt/sources.list.old;
    sudo cp ./sources.list /etc/apt/sources.list;

    #Instalando prérequisitos
    echo "(02/15)Instalando os softwares prerequisitos";
    sudo apt-get update;
    sudo apt-get install curl apt-transport-https snapd apt -y;

    #Atualizando o sistema
    echo "(03/15)Atualizando o sistema";
    sudo apt update;
    sudo apt full-upgrade -y;

    #Fazendo download dos repositórios necessário
    echo "(04/15)Adicionando os repositórios";
    ...
    echo "(05/15)Atualizando a lista de repositorios";
    sudo apt update;

    #Obtendo automaticamente os novos drivers
    echo "(06/15)Instalando os drivers";
    sudo ubuntu-drivers autoinstall;

    #Baixando e Instalando os pacotes apt
    echo "(07/15)Instalando os pacotes pelo grenciador de pacotes APT";
    ...
    echo "(08/15)Instalando o repositorio flathub";
    sudo flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo;

    #Baixando e Instalando os pacotes snap
    echo "(09/15)Instalando pacotes snap";
    ...
    echo "(10/15)Instalando pacotes flatpak"
    ...
    echo "(12/15)Instalando o Logisim";
    ...
    echo "(13/15)Desinstalando programas inuteis";
    ...
    echo "(14/15)Configurando atualizacoes automaticas";
