...
#Para o Ubuntu 20
    ...
    echo "alias update='sudo apt update && sudo apt full-upgrade -y && sudo snap refresh && flatpak update -y && sudo do-release-upgrade && sudo ubuntu-drivers autoinstall'" | tee -a ~/.bashrc;
